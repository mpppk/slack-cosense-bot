/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c6d83fc31e78afb8e292d1e41f5041f)
...
interface __BaseEnv_Env {
	...
	SLACK_BOT_USER_NAME: "cosense-bot";
	Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
	SlackCosenseBot: DurableObjectNamespace<import("./src/index").SlackCosenseBot>;
	ThinkMessengerStateAgent: DurableObjectNamespace<import("./src/index").ThinkMessengerStateAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "SlackCosenseBot" | "ThinkMessengerStateAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENROUTER_MODEL" | "COSENSE_PROJECTS" | "COSENSE_ORIGIN" | "SLACK_BOT_USER_NAME">> {}
}
declare module "*.md" {
	const value: string;
